...
import 'package:newtenaga/Widget/indicator/bb.dart';
...
class Basketball extends StatefulWidget {
  ...
  Basketball({required this.user, super.key});

  User user;

  @override
  State<Basketball> createState() => _WeightLossState();
}
...
class _WeightLossState extends State<Basketball> {
  bool tablet = true;
  ...
  Widget build(BuildContext context) {
    ...
    builder: (context, snapshot) {
      ...
      if (snapshot.hasData) {
        var basketball = snapshot.data!;
        int progress = basketball.bbProgress;
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(107, 26, 12, 1),
                  Color.fromRGBO(218, 112, 20, 1)
                ],
                                    ...
                                    AwesomeDialog(
                                      ...
                                      btnOkOnPress: () {
                                        FirebaseFirestore.instance
                                            ...
                                            .doc(widget.user.uid)
                                            .delete();
                                            FirebaseFirestore.instance.collection('basketball_daily_program').doc(widget.user.uid).delete();
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          BbIndicator(user: widget.user, mainProgress: basketball.bbProgress,)
                                        ],
                                      ),
                                    ),
                                  ),
