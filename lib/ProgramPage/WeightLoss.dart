...
import 'package:newtenaga/Widget/indicator/wl.dart';
import 'package:newtenaga/Widget/progess-indicator.dart';
import 'package:newtenaga/Widget/weightloss-indicator.dart';
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          int progress = weightLoss.wlProgress;
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(46, 69, 98, 1),
                  Color.fromRGBO(0, 136, 164, 1)
                ],
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                              ...
                              color: const Color.fromARGB(255, 10, 80, 137),
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                AwesomeDialog(
                                  ...
                                  btnCancelOnPress: (){},
                                  btnOkOnPress: () {
                                    FirebaseFirestore.instance.collection('weightLoss_progress').doc(widget.user.uid).delete();
                                    FirebaseFirestore.instance.collection('weightLoss_daily_program').doc(widget.user.uid).delete();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text('Initial Weight: ${weightLoss.wlInitial}'),
                                          const SizedBox(width: 50),
                                          Text('Final Weight: ${weightLoss.wlTarget}'),
                                        ],
                                      ),
                                      const SizedBox(
                                        height: 10,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ChallengeProgress(
                                          ...
                                          Text('kilometers', style: TextStyle(color: Color.fromARGB(255, 158, 158, 158)),),
                                    ],
                                  ),
                                ),
                              ),
