...
import 'package:newtenaga/Widget/indicator/bt.dart';
...
class _BadmintonState extends State<Badminton> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(stream: FirestoreHelper().streamBtProgress(),
    builder: (context, snapshot) {
      ...
      if (snapshot.hasData) {
        ...
        int progress = badminton.btProgress;
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(0, 107, 77, 1),
                  Color.fromRGBO(1, 143, 154, 1)
                ],
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                              ...
                              padding: EdgeInsets.zero,
                              color: Color.fromARGB(167, 0, 9, 16),
                              onPressed: () {
                                AwesomeDialog(
                                  context: context,
                                  ...
                                  btnCancelOnPress: (){},
                                  btnOkOnPress: () {
                                    FirebaseFirestore.instance.collection('badminton_progress').doc(widget.user.uid).delete();
                                    FirebaseFirestore.instance.collection('badminton_daily_program').doc(widget.user.uid).delete();
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      BtIndicator(user: widget.user, mainProgress: badminton.btProgress,)
                                    ],
                                  ),
                                ),
                              ),
